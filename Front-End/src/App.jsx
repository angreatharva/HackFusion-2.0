  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Admin only routes */}
        <Route path="/create-poll" element={role === "admin" ? <CreatePoll token={token} /> : <Home />} />
        {/* Student only routes */}
        <Route path="/vote-poll" element={role === "student" ? <VotePoll token={token} /> : <Home />} />
        <Route path="/pollsList" element={<PollsList token={token} />} />
        <Route path="/applicationForm" element={<ApplicationForm token={token} />} />
        ...
        <Route
          path="/complaintForm"
          element={<ComplaintForm onSubmitSuccess={(data) => console.log("Complaint submitted:", data)} />}
        />
        <Route path="/complaintList" element={<ComplaintsList userRole="user" />} />

        <Route path="/healthReport" element={<HealthReport />} />
        <Route path="/studentAppointmentForm" element={<StudentAppointmentForm />} />
